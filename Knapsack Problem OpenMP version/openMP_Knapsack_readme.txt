Program Written By: Michael Crawford

This program solves a user-specified Knapsack problem(s) by brute force. It
uses the maximum number of cores available.
...
[user@server]$ g++ -fopenmp openMP_Knapsack.cpp
...
Running: This program takes one argument
